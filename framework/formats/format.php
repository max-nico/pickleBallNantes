			...
			<article id="post-<?php the_ID(); ?>" <?php post_class();?> >
				<?php } else  { ?>
					<?php if( has_post_thumbnail()) { ?>
						<article data-catslug-post="<?php echo implode(' ', $getAllCats) ?>" id="post-<?php the_ID();?>" <?php if($type_class != 'post-set') { echo post_class("post-set col-md-6 $type_class"); } ?>>
					<?php } else  { ?>
						<article data-catslug-post="<?php echo implode(' ', $getAllCats) ?>" id="post-<?php the_ID();?>" <?php if($type_class != 'post-set') { echo post_class("post-set col-md-6 no-thumbnail $type_class"); } ?>>
					<?php } ?>
				<?php } ?>
		<?php
